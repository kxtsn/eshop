...
/**
 * Cart component displays a shopping cart icon with a counter for the total items in the cart.
 * 
 * @returns {JSX.Element} JSX representation of the Cart component.
 */
const Cart = () => {
  // Access the cart array from the CartContext
